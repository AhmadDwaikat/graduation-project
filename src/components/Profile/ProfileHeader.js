...
import { AppBar, Toolbar, Typography, IconButton, Box, Avatar, Menu, MenuItem, ListItemIcon, Button } from '@mui/material';
import { Settings as SettingsIcon, ExitToApp as ExitToAppIcon, Dashboard as DashboardIcon, Event as EventIcon, Favorite as FavoriteIcon } from '@mui/icons-material'; // Removed AccountCircleIcon
