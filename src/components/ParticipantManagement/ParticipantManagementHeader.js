...
import { AppBar, Toolbar, Typography, IconButton, Box, Menu, MenuItem, Avatar, ListItemIcon, Button } from '@mui/material';
import { AccountCircle as AccountCircleIcon, Settings as SettingsIcon, ExitToApp as ExitToAppIcon, Dashboard as DashboardIcon } from '@mui/icons-material';
import { Link as RouterLink, useNavigate } from 'react-router-dom';
import axios from 'axios';
import PropTypes from 'prop-types';

const ParticipantManagementHeader = ({ eventId }) => {
  ...
  ParticipantManagementHeader.propTypes = {
    eventId: PropTypes.string.isRequired,
  };
  
  export default ParticipantManagementHeader;
